    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_instanceDestinationId": "G-MGR6JSR2BN",
                "tag_id": 3
            }, {
...
*/
    ...
    ;
    var Cc = function(a) {
        return a instanceof Bc && a.constructor === Bc ? a.h : "type_error:SafeHtml"
    };
    function Dc(a, b) {
        var c = [new jc(Ec[0].toLowerCase(),hc)];
        if (0 === c.length)
            throw Error("");
    ...
    ;var l = window
      ...
      , Lc = z.currentScript && z.currentScript.src
      , Mc = function(a, b) {
        var c = l[a];
        l[a] = void 0 === c ? b : c;
        return l[a]
    ...
    var Rc = function(a, b, c, d, e) {
      ...
      , Tc = function(a, b, c, d, e) {
        ...
        if (Lb(23)) {
            if (h) {
                var n = z.body && z.body.lastChild || z.body || z.head;
    ...
    ;
    nd.prototype.ac = function() {
        return new Ya(Pa(this, 1))
    }
    ;
    nd.prototype.invoke = function(a, b) {
        return this.T.apply(new od(this,a), Array.prototype.slice.call(arguments, 1))
    }
    ;
    ...
    var vd = function(a) {
        Oa.call(this);
        this.h = a;
        this.set("then", td(this));
        this.set("catch", td(this, !0));
        this.set("finally", td(this, !1, !0))
    };
    wa(vd, Za);
    ...
    var Bd = {
      ...
      , Gd = function(a, b, c) {
        ...
        if (a instanceof nd || a instanceof Za) {
            if (a.has(b)) {
                var u = a.get(b);
                if (u instanceof nd) {
                    var v = Va(c);
            ...
            if ("toString" === b)
                return a instanceof nd ? a.M : a.toString();
            if ("hasOwnProperty" === b)
                return a.has.apply(a, Va(c))
        }
        if (a instanceof sd && "toString" === b)
            return a.toString();
    ...
    function Td(a, b, c) {
        ...
        if (b instanceof Za || b instanceof Ya || b instanceof nd) {
            var d = b.ac()
              , e = d.length();
            return Sd(a, function() {
                return e
    ...
    var ae = function(a, b, c, d) {
      ...
      , de = function(a, b) {
        ...
        if (a instanceof Za || a instanceof Ya || a instanceof nd)
            c = a.get(b);
      ...
      , ge = function(a, b) {
        a = G(this, a);
        b = G(this, b);
        a instanceof sd && (a = a.h);
        b instanceof sd && (b = b.h);
        return a === b
    }
      , he = function(a, b) {
      ...
      , ye = function(a, b, c) {
        ...
        (a instanceof nd || a instanceof Ya || a instanceof Za) && a.set(b, c);
        return c
    }
      , ze = function(a, b) {
        return G(this, a) - G(this, b)
    ...
    function Se(a) {
        if (a instanceof Da || a instanceof nd || a instanceof Ya || a instanceof Za || a instanceof sd || null === a || void 0 === a || "string" === typeof a || "number" === typeof a || "boolean" === typeof a)
            return a
    }
    ;var Ue = function(a) {
        this.message = a
    ...
    var tf;
    var uf = [], vf = [], wf = [], xf = [], yf = [], zf = {}, Af, Bf, Cf = function(a) {
        Bf = Bf || a
    }, Df = function(a) {}, Ef, Ff = [], Gf = [], Hf = function(a, b) {
        var c = {};
        c[Xe.ma] = "__" + a;
        for (var d in b)
        ...
        var e = zf[c], f = b && 2 === b.type && d.reportMacroDiscrepancy && e && -1 !== Ff.indexOf(c), g = {}, h = {}, m;
        for (m in a)
        ...
        var d = {}, e;
        for (e in a)
            a.hasOwnProperty(e) && (d[e] = Jf(a[e], b, c));
        return d
    }, Jf = function(a, b, c) {
        if (Array.isArray(a)) {
            var d;
            ...
            case "template":
                ...
                return Bf && p ? Bf.Fl(d) : d.join("");
            case "escape":
                d = Jf(a[1], b, c);
                if (Bf && Array.isArray(a[1]) && "macro" === a[1][0] && Bf.wm(a))
                    return Bf.Wm(d);
                d = String(d);
    ...
    ;var Vf = function(a) {
      ...
      , Tf = function(a) {
        var b = [];
        return function(c) {
            void 0 === b[c] && (b[c] = Mf(wf[c], a));
            return b[c]
        }
    };
    var Wf = {
        Dl: function(a, b) {
            b[Xe.ni] && "string" === typeof a && (a = 1 == b[Xe.ni] ? a.toLowerCase() : a.toUpperCase());
            b.hasOwnProperty(Xe.ri) && null === a && (a = b[Xe.ri]);
            b.hasOwnProperty(Xe.ui) && void 0 === a && (a = b[Xe.ui]);
            b.hasOwnProperty(Xe.si) && !0 === a && (a = b[Xe.si]);
            b.hasOwnProperty(Xe.oi) && !1 === a && (a = b[Xe.oi]);
            return a
        }
    };
    var Xf = function() {
      ...
      , J = function(a, b, c) {
        for (var d = 0; d < b.length; d++) {
            ...
            if (null == m) {
                ...
                var n = typeof m;
                m instanceof nd ? n = "Fn" : m instanceof Ya ? n = "List" : m instanceof Za ? n = "PixieMap" : m instanceof sd && (n = "OpaqueValue");
                if (n != h)
      ...
      , Yg = function(a, b) {
        ...
        for (d in b)
            if (b.hasOwnProperty(d)) {
                var e = b[d];
                kb(e) ? c.set(d, Xg(a + "_" + d, e)) : Ta(e) ? c.set(d, Yg(a + "_" + d, e)) : (lb(e) || k(e) || "boolean" === typeof e) && c.set(d, e)
            }
        c.Kb();
        return c
    };
    ...
    var jh = function(a, b) {
      ...
      , kh = function(a, b) {
        ...
        if (c) {
            ...
            switch (d) {
            case "hitData":
                return 2 > a.length ? void 0 : jh(c.getHitData(a[1]), a.slice(2));
            case "metadata":
                return 2 > a.length ? void 0 : jh(c.getMetadata(a[1]), a.slice(2));
            case "eventName":
    ...
    $h)
      , bi = {}
      , ci = (bi.email = "sha256_email_address",
      ...
      , hi = function(a) {
        for (var b = ["tv.1"], c = 0, d = 0; d < a.length; ++d) {
            var e = a[d].name
              ...
              , g = a[d].index
              , h = ai[e];
            h && f && (-1 === di.indexOf(e) || /^e\d+$/.test(f) || Zh.test(f) || Wh.test(f)) && (void 0 !== g && (h += g),
            b.push(h + "." + f),
            c++)
        }
    ...
    oi[M.g.qg] = 1,
    oi))
      , qi = Object.freeze([M.g.ka, M.g.lb, M.g.vc, M.g.xc, M.g.dd, M.g.Ka, M.g.Xb])
      , ri = Object.freeze([].concat(qi))
      , si = Object.freeze([M.g.Va, M.g.Ud, M.g.kd, M.g.rf, M.g.Pd])
    ...
    Ai.ne = Number("0") || 0;
    Ai.ja = "dataLayer";
    Ai.Dn = "ChEI8OSJsAYQqpjTo+363OOrARIlAMg/fpEfvAM0yhfjS70Gjp9jUS9vqc6TarZqD+9uCCjCsUOAORoCaDM\x3d";
    var Di = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var Li, Mi = !1;
    Li = Mi;
    Ai.Fd = "www.googletagmanager.com";
    var Ni = "" + Ai.Fd + (Hi ? "/gtag/js" : "/gtm.js")
      , Oi = null
      , Pi = null
      , Qi = {}
      , Ri = {}
    ...
    var Xi = new pb
      ...
      , fj = function(a, b) {
        var c, d = 1 !== (void 0 === b ? 2 : b) ? cj(a) : Xi.get(a);
    ...
    var nj;
    try {
        nj = JSON.parse(eb("eyIwIjoiQkQiLCIxIjoiQkQtQiIsIjIiOmZhbHNlLCIzIjoiZ29vZ2xlLmNvbS5iZCIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        L(123),
        mj(2),
        nj = {}
    ...
    function Qj(a) {
        for (var b = ma([M.g.jd, M.g.Jb]), c = b.next(); !c.done; c = b.next()) {
            var d = R(a, c.value);
            if (d)
                return d
        }
    ...
    function Rj(a, b) {
        return Ui.s ? "" + Vi() + (b ? Hj[a] || "" : "") : a
    }
    ;var Sj = function(a) {
        var b = String(a[Xe.ma] || "").replace(/_/g, "");
        0 === b.indexOf("cvt") && (b = "cvt");
        return b
    }
      , Tj = 0 <= l.location.search.indexOf("?gtm_latency=") || 0 <= l.location.search.indexOf("&gtm_latency=");
    var Vj = function(a, b) {
        var c = Uj();
        c.pending || (c.pending = []);
    ...
    var bk = function() {
      ...
      , Zj = function() {
        return bg.Wj ? bg.Wj.split("|") : [bg.ctid]
    }
      , ck = function() {
        return bg.Xj ? bg.Xj.split("|") : []
    }
      , jk = function() {
        var a = hk(ik());
        if (a) {
    ...
    var ok = function() {
        for (var a = bg.ctid, b = bk(), c = dk(), d = function(n, p) {
            var q = {
    ...
    aa.getConsentState = function(a) {
        ...
        if (void 0 !== d)
            return d ? 1 : 2;
        d = c.implicit;
        return void 0 !== d ? d ? 3 : 4 : Lb(19) && hl.hasOwnProperty(a) ? (gb("TAGGING", 22),
        hl[a] ? 3 : 4) : 0
    }
    ;
    ...
    ;var Al = [M.g.J, M.g.R, M.g.N, M.g.za], Bl, Cl, Dl = function(a) {
        ...
        ++d.sd)
            a.hasOwnProperty("all") && rb(zi, function(e) {
                return function(f) {
                    nl(f, a.all, c[e.sd])
                }
            }(d)),
    ...
    var Ml = function() {
        ...
        if (void 0 === Bi.pscdl)
            try {
                "cookieDeprecationLabel"in Jc ? (a("pending"),
                Jc.cookieDeprecationLabel.getValue().then(a)) : a("noapi")
            } catch (b) {
                a("error")
            }
    };
    ...
    Xl))
      , Zl = 0 <= z.location.search.indexOf("?gtm_diagnostics=") || 0 <= z.location.search.indexOf("&gtm_diagnostics=")
      , am = function(a, b, c) {
    ...
    ;var cm = function(a, b, c, d, e, f, g, h, m, n, p) {
      ...
      , sm = function(a) {
        return new cm(a.Ef,a.Ff,a.C,a.Zb,a.h,a.F,a.Yb,a.s,a.Ra,a.T,a.M)
    };
    var tm = {};
    function um(a, b, c) {
    ...
    Mm() || vc("Macintosh");
    Mm() || vc("Windows");
    (Mm() ? "Linux" === sc.platform : vc("Linux")) || Mm() || vc("CrOS");
    Mm() || vc("Android");
    Nm();
    vc("iPad");
    vc("iPod");
    ...
    var cn = function(a) {
      ...
      , dn = function(a, b) {
        ...
        this.Ra = 0;
        var c;
        this.T = null != (c = b.vn) ? c : 500;
        var d;
        this.F = null != (d = b.io) ? d : !1;
        this.C = null
    };
    wa(dn, bn);
    var fn = function(a) {
                ...
                b.addEventListener(function(c) {
                    ...
                    !sn(c) || pn() || qn()) {
                            ...
                            for (h in mn)
                                if (mn.hasOwnProperty(h))
                                    if ("1" === h) {
                                        ...
                                        p = void 0 === p ? {} : p;
                                        m = ln(n) ? !1 === n.gdprApplies ? !0 : "tcunavailable" === n.tcString ? !p.Sj : (p.Sj || void 0 !== n.gdprApplies || p.Sl) && (p.Sj || "string" === typeof n.tcString && n.tcString.length) ? jn(n, "1", 0) : !0 : !1;
                                        g["1"] = m
                                    } else
                                        g[h] = jn(c, h, mn[h]);
                            d = g
                        ...
                        if (d) {
                            ...
                            a.jc = d;
                            var q = {}
                              , r = (q[M.g.J] = a.jc["1"] ? "granted" : "denied",
                            q);
                            !0 !== a.gdprApplies ? (Ll([M.g.J, M.g.za, M.g.N]),
                            il().active = !0) : (r[M.g.za] = a.jc["3"] && a.jc["4"] ? "granted" : "denied",
                            "number" === typeof a.tcfPolicyVersion && 4 <= a.tcfPolicyVersion ? r[M.g.N] = a.jc["1"] && a.jc["7"] ? "granted" : "denied" : Ll([M.g.N]),
                            Fl(r, {
                                eventId: 0
                            }, {
    ...
    var Hn = function(a) {
      ...
      , In = function() {
        if (!pl(M.g.N))
            return "-";
        for (var a = Object.keys(zi), b = rl(a), c = "", d = ma(a), e = d.next(); !e.done; e = d.next()) {
            var f = e.value;
            b[f] && (c += zi[f])
        }
        return c || "-"
    ...
    var Xn = {
      ...
      , Yn = function(a, b) {
        ...
        d.te !== a && (d.fg = a);
        Q(71) ? d.jk = 2 : Q(70) && (d.jk = 1);
        Hi ? (d.Zf = Xn[c],
        d.Zf || (d.Zf = 0)) : d.Zf = Li ? 13 : 10;
        Ui.F ? (d.Vf = 0,
        d.yl = 2) : Ji ? d.Vf = 1 : Wn() ? d.Vf = 2 : d.Vf = 3;
        var e = {};
        e[6] = Yj;
        d.Cl = e;
        var f;
        ...
        void 0 === g ? f = "" : (h || (h = 0),
        f = "" + Sg(1, 1) + Ve(g << 2 | h));
        var m = d.yl, n = 4 + f + (m ? "" + Sg(2, 1) + Ve(m) : ""), p, q = d.kn;
        ...
        if (v && b) {
            ...
            if ("GTM" !== x && "OPT" !== x)
                ...
                var y = w[1];
                u = "" + Sg(5, 3) + Ve(1 + y.length) + (d.Gm || 0) + y
            }
        } else
            u = "";
        var B = d.jk, A = d.te, E = d.fg, F = d.po, C = n + p + r + u + (B ? "" + Sg(6, 1) + Ve(B) : "") + (A ? "" + Sg(7, 3) + Ve(A.length) + A : "") + (E ? "" + Sg(8, 3) + Ve(E.length) + E : "") + (F ? "" + Sg(9, 3) + Ve(F.length) + F : ""), H;
        var O = d.Cl;
        O = void 0 === O ? {} : O;
    ...
    function Jo(a, b) {
        var c = [Jc.userAgent, (new Date).getTimezoneOffset(), Jc.userLanguage || Jc.language, Math.floor(yb() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"), d;
        if (!(d = xo)) {
    ...
    function Po(a, b) {
        function c(n, p, q) {
            ...
            if (r) {
                ...
                var y = v.join("*");
                u = ["1", Jo(y), y].join("*");
                d ? (Lb(13) || Lb(11) || !p) && Qo("_gl", u, a, p, q) : Ro("_gl", u, a, p, q)
            }
        }
    ...
    function Np(a, b) {
        var c = Lb(20), d = Ej(a), e = Aj(d, "query", !1, void 0, "gclid"), f = Aj(d, "query", !1, void 0, "gclsrc"), g = Aj(d, "query", !1, void 0, "wbraid"), h;
    ...
    var Pp = function() {
      ...
      , Op = function(a, b, c, d, e) {
        ...
        g(d, "gb"));
        Lb(20) && void 0 !== e && wp.test(e) && (f.gbraid = e,
        g(e, "ag"));
        return f
    }
      , Rp = function(a) {
    ...
    function Qp(a, b, c, d, e) {
        ...
        var g = Math.round(d / 1E3)
          ...
          , p = function() {
            ...
            if (!n && Lb(20) && a.gbraid && zp("ad_storage") && (n = !0,
            !m)) {
                var B = a.gbraid
                  , A = Gp("ag", f);
    ...
    var Dq = /^(www\.)?google(\.com?)?(\.[a-z]{2}t?)?$/
      ...
      , Gq = function(a) {
        a || (a = Fq());
        return a.An ? !1 : a.im || a.jm || a.km || a.Ah || a.wh || a.Rl || a.Yl ? !0 : !1
    }
      , Fq = function() {
        var a = {}
          , b = Mo(!0);
    ...
    var $q = function(a) {
        if (a.eventName === M.g.ba && "page_view" === a.metadata.hit_type)
            if (Q(19)) {
                a.metadata.redact_click_ids = null != R(a.m, M.g.da) && !1 !== R(a.m, M.g.da) && !T(Xq());
                var b = Yq(a)
                  , c = !1 !== R(a.m, M.g.ra);
                c || (a.h[M.g.Hk] = "1");
                var d = Fp(b.prefix);
                ...
                if (a.metadata.consent_updated)
                    ...
                    a.h[M.g.Nd] = m.dclid;
                    a.h[M.g.Fi] = m.gclsrc;
                    a.h[M.g.Gd] || a.h[M.g.Nd] || (a.h[M.g.Ze] = m.wbraid,
                    a.h[M.g.Gi] = m.gbraid);
                ...
                a.h[M.g.Ta] = void 0;
                var q = Q(61);
                if (!a.h[M.g.Gd] && !a.h[M.g.Nd] && Uq(d, q)) {
      ...
      , Yq = function(a) {
        return {
            prefix: R(a.m, M.g.Ya) || R(a.m, M.g.Oa),
            domain: R(a.m, M.g.Ua),
            yb: R(a.m, M.g.Va),
            flags: R(a.m, M.g.Za)
        }
      ...
      , Zq = function(a) {
        var b = a.xd
          , c = a.Dd
          , d = a.hc;
        a.rd && (Wo(b[M.g.Ub], !!b[M.g.W]) && (Tp(br, d),
        Up(d),
        hp(d)),
        Rp(d),
        Yp(br, d),
      ...
      , ds = function() {
        ...
        for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
            ...
            if (!(0 <= as.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
                ...
                (!f || Q(23) && -1 !== cs.indexOf(e.tagName)) && a.push(e)
            }
        }
        return {
            elements: a,
    ...
    var Cs = function(a) {
        return Bq(a, M.g.Sb, R(a.m, M.g.Sb)) || Bq(a, "google_ono", !1)
    }
      , Ds = function(a) {
    ...
    var Js = function(a, b) {
        ...
        var d = function(e, f, g) {
            ...
            this.M = this.T = this.heartbeatCount = this.ml = 0;
            this.Ef = !1;
            this.s = {};
            this.state = 0;
            this.Uf = Is(this.h);
        ...
        d.prototype.getState = function() {
            return {
                state: this.state,
                Uf: Math.round(Is(this.h) - this.Uf),
                gg: Math.round(Is(this.h) - this.gg)
            }
        }
        ;
            ...
            this.Yb({
                ...
                if (0 === f.type) {
                    ...
                    if (null != (null == (g = f.failure) ? void 0 : g.failureType))
                        ...
                        if (e.heartbeatCount > f.stats.heartbeatCount + Hs.pj) {
                            e.heartbeatCount = f.stats.heartbeatCount;
                            var p, q;
                            null == (q = (p = e.na).onFailure) || q.call(p, {
                                failureType: 10
                            })
                        }
                        e.stats = f.stats;
                        ...
                        if (2 !== r)
                            if (e.Ef) {
                                var t, u;
                                null == (u = (t = e.na).no) || u.call(t)
                            } else {
                                e.Ef = !0;
                                var v, w;
                                null == (w = (v = e.na).Pm) || w.call(v)
                            }
                        e.M = 0;
                        e.pl();
                        e.rj()
        ...
        d.prototype.Ff = function() {
            return 2 === this.state ? Hs.Sk : Hs.ol
        }
        ;
        d.prototype.rj = function() {
            ...
            this.h.setTimeout(function() {
                e.Ra()
            }, Math.max(0, this.Ff() - (Is(this.h) - this.T)))
        }
        ;
            ...
            this.Yb({
                ...
                if (1 === m.type)
                    if (m.result)
                        ...
                        null == (u = (t = h.na).onFailure) || u.call(t, r);
                        g(r)
                    }
            })
        }
        ;
        d.prototype.Yb = function(e, f) {
            var g = this;
            if (4 === this.state)
                e.failure = {
                    failureType: this.F
        ...
        d.prototype.fl = function() {
            for (var e in this.s)
                this.nd(this.s[e], this.F)
        }
        ;
        d.prototype.nd = function(e, f) {
            this.Zb(e);
            var g = e.request;
            g.failure = {
                failureType: f
        ...
        ;
        d.prototype.Zb = function(e) {
            delete this.s[e.request.requestId];
            this.h.clearTimeout(e.Jm)
        }
        ;
        d.prototype.gm = function(e) {
            this.T = Is(this.h);
            ...
            if (f)
                ...
                var g, h;
                null == (h = (g = this.na).onFailure) || h.call(g, {
                    failureType: 11
                })
            }
        }
    ...
    var Ks = "https://" + Ai.Fd
      ...
      , Ss = ob();
    var Ws = function(a, b) {
        var c = Math.round(yb()), d, e = null == (d = Ts()) ? void 0 : d.initTime, f, g = null == (f = Ts()) ? void 0 : f.getState();
        Us(12, void 0, void 0, 0);
        var h = "_is_sw=f12";
        void 0 !== g && (h += "s" + g);
        h = (e ? h + ("t" + (c - e)) : h + "te") + ("g" + (Vs(b) ? 1 : 0));
        a(h)
    }
      , Ys = function(a) {
        a = void 0 === a ? [] : a;
        Rs >= Ms || (Xs("pid", Ss, a),
        Xs("bc", ++Rs, a),
        a.unshift("ctid=" + bg.ctid + "&t=s"),
        Uc("https://www.googletagmanager.com/a?" + a.join("&")))
    }
      , Zs = function(a, b) {
      ...
      , $s = function() {
        ...
        if (a) {
            var b;
            return Aj(Ej(a), "host") === (null == (b = l.location) ? void 0 : b.host) ? 1 : 2
        }
        return 0
    }
      , bt = function(a, b) {
        ...
        try {
            var d = c.contentDocument.createElement("iframe")
              , e = Qs ? "&1p=1" : "";
            Tc(Ps + "sw_iframe.html?origin=" + encodeURIComponent(a) + e, void 0, void 0, void 0, d);
            var f = function() {
      ...
      , Ts = function() {
        var a = Bi.sw_endpoint;
        return a && a[Os]
    };
    function dt() {
        var a = !1;
        var b;
        a = 2 === (null == (b = Ts()) ? void 0 : b.getState());
        return a
    }
    function et(a) {
        var b = Math.round(yb());
        var c = l.location.origin;
        if (!c)
            return;
        Ui.s && (a = "" + c + Vi() + "/_");
        if (!ct(a) || Ts())
        ...
        var d = !1, e, f = Js(function(n) {
            var p;
            null == (p = e) || p.postMessage(n, Os)
        }, {
            Pm: function() {
                d = !0;
                at(f.getState(), f.stats);
                ft()
            },
            Om: function(n) {
                d ? Us((null == n ? void 0 : n.failureType) || 7, f.getState(), f.stats, void 0, null == n ? void 0 : n.data) : at(f.getState(), f.stats, (null == n ? void 0 : n.failureType) || 1, null == n ? void 0 : n.data)
            },
            onFailure: function(n) {
                Us(n.failureType, f.getState(), f.stats, n.command, n.data)
            }
        }), g = !1, h = function() {
            g || f.init();
            g = !0
        ...
        D(function() {
            bt(c, function(n, p) {
                ...
                n.contentWindow.addEventListener("message", function(q) {
                    q.origin === Os && f.gm(q.data)
                });
                h()
            })
        });
        var m = Bi.sw_endpoint;
        m || (m = Bi.sw_endpoint = {});
        m[Os] = {
    ...
    function gt(a, b, c) {
        var d;
        if (null == (d = Ts()) || !d.delegate) {
            c({
                failureType: 1
            });
            return
        }
        Ts().delegate(a, null != b ? b : function() {}
        , null != c ? c : function() {}
        );
    }
    function at(a, b, c, d) {
        var e = $s(), f, g = [];
        f = l === l.top && 0 !== e && b ? 1 < (null == b ? void 0 : b.clientCount) ? 2 == e ? 1 : 2 : 2 == e ? 0 : 3 : 4;
        a && Xs("si", a.Uf, g);
        Xs("m", 0, g);
        Xs("iss", f, g);
        Xs("if", c, g);
        Zs(b, g);
        d && Xs("fm", encodeURIComponent(d.substring(0, Ns)), g);
        Ys(g);
    }
    function Us(a, b, c, d, e) {
        ...
        Zs(c, f);
        Xs("c", d, f);
        e && Xs("fm", encodeURIComponent(e.substring(0, Ns)), f);
        Ys(f);
    }
    function ht(a, b, c, d, e) {
        if (dt()) {
            var f, g = null == (f = Ts()) ? void 0 : f.initTime, h = Math.round(yb());
            gt({
                commandType: 0,
                params: {
                    url: a,
                ...
                m && m.failureType ? e("_is_sw=f" + m.failureType + "g" + (Vs(c) ? 1 : 0)) : e()
            })
        } else
            Ws(e, c);
    }
    function it(a, b, c, d) {
        var e = b ? 1 : 0;
        if (dt()) {
            var f = Math.round(yb()), g, h = null == (g = Ts()) ? void 0 : g.initTime, m = {
                commandType: 0,
                params: {
                    url: a,
                    method: e,
            ...
            Q(22) && (m.params.attributionReporting = !0);
            gt(m, function() {}, function(n) {
    ...
    function jt(a) {
        ...
        for (var e = ma(a), f = e.next(); !f.done; f = e.next()) {
            var g = f.value;
            if ("" !== g.value) {
                var h, m = void 0, n = g.name, p = g.value, q = ai[n];
                if (q) {
                    var r = null != (m = g.index) ? m : ""
                      , t = q + "__" + d;
                    -1 === di.indexOf(n) || /^e\d+$/.test(p) || Zh.test(p) || Wh.test(p) ? h = encodeURIComponent(encodeURIComponent(p)) : (h = "${userData." + t + "|sha256}",
                    b[t] = p,
                    d++);
                    c.push("" + q + r + "." + h)
                }
    ...
    function mt(a) {
        var b = [];
        var c = a.Bb;
        void 0 !== lt && (b.push(["ual", Math.floor(lt)]),
        c && (lt = void 0));
        return b
    }
    ;var nt = function(a) {
    ...
    zc();
    !vc("Safari") || zc() || (wc() ? 0 : vc("Coast")) || xc() || (wc() ? 0 : vc("Edge")) || (wc() ? uc("Microsoft Edge") : vc("Edg/")) || (wc() ? uc("Opera") : vc("OPR")) || yc() || vc("Silk") || vc("Android") || Om();
    var ot = {}
      , pt = null
      , qt = function(a) {
        for (var b = [], c = 0, d = 0; d < a.length; d++) {
    ...
    ;var Ft = !1;
    function Gt() {
        if (Et("join-ad-interest-group") && kb(Jc.joinAdInterestGroup))
            return !0;
        ...
        Ft = !0);
        return Et("join-ad-interest-group") && kb(Jc.joinAdInterestGroup)
    }
    function Ht(a, b) {
        var c = void 0;
        try {
        ...
        if (c) {
            ...
            try {
                if (z.querySelectorAll('iframe[allow="join-ad-interest-group"][data-tagging-id*="-"]').length >= (void 0 == Kb[2] ? 50 : Kb[2])) {
                    gb("TAGGING", 10);
                    return
                }
            } catch (e) {}
    ...
    var aw = function(a, b, c, d, e) {
        if (!$v()) {
            ...
            if (!pk(f)) {
                ...
                if (!p) {
                    var q = Ai.Fd + n;
                    m && Lc && h ? (q = Lc.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0],
                    p = nr("https://", "http://", q + g)) : p = Ui.s ? Vi() + n + g : nr("https://", "http://", q + g)
                }
                d.siloed && rk({
                    ctid: f,
                    isDestination: !1
        ...
        if (!$v()) {
            ...
            if (!qk(e))
                if (!c.siloed && sk())
                    ...
                    var f = "/gtag/destination?id=" + encodeURIComponent(a) + "&l=" + Ai.ja + "&cx=c";
                    Q(64) && (f += "&gtm=" + Yn());
                    Pj() && (f += "&sign=" + Ai.Jf);
                    var g = Oj() ? Nj(b, f) : void 0;
                    g || (g = Ui.s ? Vi() + f : nr("https://", "http://", Ai.Fd + f));
                    c.siloed && rk({
                        ctid: e,
                        isDestination: !0
                    });
    ...
    ;var Iw = {}
      ...
      , Kw = {};
    function Lw(a, b, c, d) {
        Ck && Q(74) && ((void 0 === d ? 0 : d) ? (Kw[b] = Kw[b] || 0,
    ...
    function Uw(a, b, c, d) {
        function e() {
            if (f[Xe.Xk])
                ...
                var B = mw(c.fc, String(f[Xe.ma]), Number(f[Xe.pe]), w[Xe.Yk])
                  , A = !1;
            ...
            if (a[d]) {
                ...
                try {
                    ...
                    if (g) {
                        ...
                        c.push({
                            kk: d,
                            Zj: (m ? m.priorityOverride || 0 : 0) || Lv(e[Xe.ma], 1) || 0,
                            execute: g
                        })
                    } else
                        Rx(d, b),
    ...
    var by = function(a) {
        ...
        Q(74) && Ck && (p.reportMacroDiscrepancy = Lw);
        Q(65) && mv(p.id, p.name);
        var q = Vf(p);
        Q(65) && nv(p.id, p.name);
        f && (q = $x(q));
    ...
    function Yx(a, b, c) {
        ...
        return function(e) {
            ...
            for (var n = Ri[f] || [], p = ma(g), q = p.next(); !q.done; q = p.next()) {
                var r = q.value;
                try {
                    if (!r({
                        entityId: f,
    ...
    function $x(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                var d = String(xf[c][Xe.ma]);
                if (Di[d] || void 0 !== xf[c][Xe.bl] || Lv(d, 2))
                    b[c] = !0
            }
        return b
    }
    function ay(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && xf[c] && !Ei[String(xf[c][Xe.ma])])
                return !0;
        return !1
    }
    var Yf;
    ...
    var ry = [M.g.jd, M.g.Jb, M.g.xc, M.g.nb, M.g.ub, M.g.Qa, M.g.sa, M.g.Oa, M.g.Ua, M.g.Rb]
      , sy = {
        config: function(a, b) {
            var c = my(a, b);
            if (!(2 > a.length) && k(a[1])) {
                ...
                if (A) {
                    ...
                    for (var E = [], F = 0; F < A.length; F++) {
                        ...
                        if (-1 !== hy.indexOf(lk(C.prefix))) {
                            var O = Ua(d)
                              , N = H.eventMetadata || {};
                            N.hasOwnProperty("is_external_event") || (N.is_external_event = !H.fromContainerExecution);
                            H.eventMetadata = N;
                            delete O[M.g.ad];
                            ym(c, O, C.id, H)
                        }
                    ...
                    0 < A.length ? g.eventModel[M.g.Wb] = E.join() : delete g.eventModel[M.g.Wb];
                    iy || L(43);
    ...
    ;function aB() {
        var a = [["cv", "1"], ["rv", Ai.bh], ["tc", xf.filter(function(b) {
            return b
        }).length]];
            ...
            if (!a)
                ...
                if (b) {
                    ...
                    xk(function(d) {
                        ...
                        d.Bb && (c = !0);
                        d.dg();
                        return [["rtg", a.canonicalContainerId], ["rlo", b.hn], ["slo", b.jn.script || 0]]
                    })
                }
            }
        }
    ...
    var uD = function(a, b) {
      ...
      , vD = function(a, b) {
        for (var c = Aj(Ej((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || ed(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++)
            try {
          ...
          , b = function(c) {
            ...
            if (d && 3 !== c.which && !(c.Dh || c.timeStamp && c.timeStamp === a)) {
                ...
                if (h.length) {
                    ...
                    if (q && !e && f && d.href) {
                        var t = !!nb(String(ed(d, "rel") || "").split(" "), function(x) {
                            return "noreferrer" === x.toLowerCase()
                        })
                          , u = l[(ed(d, "target") || "_self").substring(1)]
                          , v = !0
                          , w = $y(function() {
                            var x;
                            if (x = v && u) {
    ...
    var AD = function(a) {
      ...
      , DD = function(a, b) {
        Rz("sdl", "init", !1) && !GD() && (b ? Wc(l, "scrollend", a) : Wc(l, "scroll", a),
        Wc(l, "resize", a),
        Pz("sdl", "init", !1))
    }
      , CD = function() {
    ...
    function KD(a, b) {
        ...
        D(function() {
            ...
            if (GD()) {
                var e = FD();
                Q(78) && "onscrollend"in l ? (e = ED(),
                Vc(l, "scrollend", e)) : Vc(l, "scroll", e);
                Vc(l, "resize", e)
            } else
                Pz("sdl", "init", !1)
        }));
    ...
    var Ec = ka(["data-gtm-yt-inspected-"]), ND = ["www.youtube.com", "www.youtube-nocookie.com"], OD, PD = !1;
    var QD = function(a, b, c) {
      ...
      , TD = function(a, b) {
        ...
        function f(F) {
            ...
            case 1:
                ...
                y = a.getPlaybackRate();
                b.jh ? Yy(t.createEvent("start")) : t.pd();
        ...
        function h(F) {
            ...
            case 3:
                ...
                C = 1 < Math.abs((xb().getTime() - A) / 1E3 * y - H) ? "seek" : C || "buffering";
                a.getCurrentTime() && (b.ih ? Yy(t.createEvent(C)) : t.pd());
                q();
                return m;
            case -1:
                return e(F);
      ...
      , UD = function(a, b) {
        if (!a.getAttribute("data-gtm-yt-inspected-" + b.Ab) && (Dc(a, "data-gtm-yt-inspected-" + b.Ab),
        WD(a, b.Ae))) {
            a.id || (a.id = XD());
            var c = l.YT
              , d = c.get(a.id);
    ...
    function ZD(a, b) {
        ...
        var d = !!a.get("captureStart")
          ...
          , g = SD(xd(a.get("progressThresholdsPercent")))
          , h = RD(xd(a.get("progressThresholdsTimeInSeconds")))
        ...
        D(function() {
            ...
            for (var x = z.getElementsByTagName("iframe"), y = x.length, B = 0; B < y; B++)
                if (!PD && WD(x[B], n.Ae))
                    return Rc("https://www.youtube.com/iframe_api"),
                    PD = !0,
                    b
        });
        return b
    ...
    function GF() {
        ...
        Q(42) && FF ? a = FF : (a.set("containerId", 'G-MGR6JSR2BN'),
        a.set("version", '1'),
        a.set("environmentName", ''),
        a.set("debugMode", ig),
        a.set("previewMode", kg),
        a.set("environmentMode", jg),
    ...
    var SF = {};
    SF.enableAWFledge = Q(24);
    SF.enableAdsConversionValidation = Q(15);
    SF.enableAutoPiiOnPhoneAndAddress = Q(23);
    SF.enableCachedEcommerceData = Q(29);
    SF.enableCcdPreAutoPiiDetection = Q(30);
    SF.enableCloudRecommentationsErrorLogging = Q(34);
    SF.enableCloudRecommentationsSchemaIngestion = Q(35);
    SF.enableCloudRetailInjectPurchaseMetadata = Q(37);
    SF.enableCloudRetailLogging = Q(36);
    SF.enableCloudRetailPageCategories = Q(38);
    SF.enableConsentDisclosureActivity = Q(40);
    SF.enableDCFledge = Q(45);
    SF.enableDecodeUri = Q(55);
    SF.enableDeferAllEnhancedMeasurement = Q(46);
    SF.enableEuidAutoMode = Q(49);
    SF.enableFormSkipValidation = Q(52);
    SF.enableNavigationSwEncryptionVariant = Q(69);
    SF.enableNavigationSwExperimentVariant = Q(71);
    SF.enableSharedUserId = Q(83);
    SF.enableUrlDecodeEventUsage = Q(88);
    SF.enableZoneConfigInChildContainers = Q(89);
    SF.useEnableAutoEventOnFormApis = Q(100);
    ...
    var cG = !1
      , dG = function(a) {
        var b = a.eventName === M.g.Ob && tl() && Ds(a)
        ...
        return !(!(Q(56) && Q(57) && "fetch"in l || Jc.sendBeacon) || e || m || f || g || h || b || c || !d && cG)
    };
    var eG = function(a) {
        var b = 0
          , c = 0;
    ...
    aa.Tk = function(a) {
        ...
        if (!this.h) {
            ...
            Ds(a) && -1 === (Jc.userAgent || "").indexOf("Firefox") && -1 === (Jc.userAgent || "").indexOf("FxiOS") && c(l, "beforeunload", function() {
                cG = !0
            });
            this.Zh();
            this.s = 0
    ...
    var lG = function(a, b, c) {
      ...
      , pG = function(a, b) {
        var c = a.h[M.g.nb];
        if (R(a.m, M.g.Gb) && R(a.m, M.g.Tb) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!oG(c, a))
    ...
    var sG = function(a, b, c) {
        ...
        if (!d)
            return b;
        var e, f = tb(null != (e = R(c.m, M.g.kd)) ? e : 30);
        ...
        g.Lc = d.Lc + 1;
        var h;
        return null != (h = rG(g.sessionId, g.Lc, g.Ad, g.Me, g.Jh, g.Gc, g.we)) ? h : b
    }
      , vG = function(a, b) {
      ...
      , xG = function(a) {
        return rG(a.h[M.g.ub], a.h[M.g.de], a.h[M.g.ce], Math.floor(a.metadata.event_start_timestamp_ms / 1E3), a.metadata.join_timer_sec || 0, !!a.metadata[M.g.jf], a.h[M.g.Qd])
    };
    var yG = function(a) {
        var b = R(a.m, M.g.sa)
          , c = a.m.s[M.g.sa];
      ...
      , CG = function(a) {
        var b = yG(a) || {}
          ...
          , e = tG(a, c)
          , f = {};
        Wo(b[M.g.Ub], !!b[M.g.W]) && (f = AG(a, d, e),
      ...
      , EG = function(a) {
        ...
        return !T("analytics_storage") && DG() ? zG(c, d) : {}
    }
      , DG = function() {
    ...
    var GG = function(a, b) {
      ...
      , JG = function(a) {
        ...
        var c = Cs(a)
          , d = R(a.m, M.g.lb);
        return c && !qj() && !1 !== d && HE() && T(M.g.J) && T(M.g.R) ? HG() : IG()
    }
      , KG = !1;
    KG = !0;
    var LG = {};
    ...
    PG))
      ...
      , RG = function(a, b, c) {
        ...
        var p = function(t, u) {
          ...
          , q = Q(95) && Ds(a);
        rb(a.h, function(t, u) {
            if (void 0 !== u && !li.hasOwnProperty(t)) {
                null === u && (u = "");
                var v;
                t !== M.g.Qd ? v = !1 : a.metadata.euid_mode_enabled || q ? (d.ecid = u,
                v = !0) : v = void 0;
                if (!v && t !== M.g.jf) {
                    var w = u;
                    !0 === u && (w = "1");
        ...
        var r = a.h[M.g.cb] || {};
        Q(66) && !1 === R(a.m, M.g.lb, void 0, 4) && (d.ngs = "1");
        rb(r, function(t, u) {
            void 0 !== u && ((null === u && (u = ""),
    ...
    ;var XG = function(a, b) {
      ...
      , ZG = function(a, b, c, d) {
        ...
        ;
        g.open(b ? "POST" : "GET", a);
        Q(22) && g.setAttributionReporting && g.setAttributionReporting({
    ...
    var aH = function(a, b) {
      ...
      , dH = function(a, b, c, d) {
        ...
        if (d && !cG)
            ...
            var m;
            var n = b;
            Q(56) && "fetch"in l ? Q(57) ? m = dd(a + "?" + aH(n, "_z=fetch"), c) : (cH(a, aH(n, "_z=sendBeacon"), c),
            m = !0) : m = !1;
            m || cH(a, b, c)
        }
    }
      ...
      , kH = function(a) {
        if (Ds(a)) {
            ...
            var c = function(e) {
              ...
              , d = R(a.m, M.g.Fa);
            void 0 !== d ? (c(d),
            Q(96) && (a.h[M.g.ee] = "c")) : c(a.metadata.user_data);
    ...
    var pH = function(a) {
        return !a || oH.test(a) || ni.hasOwnProperty(a)
    }
      , qH = function(a) {
        var b = M.g.Ib, c;
        c || (c = function() {}
    ...
    aa.Xm = function(a, b, c) {
        ...
        if (e)
            if (c.eventMetadata.is_external_event && "_" === a.charAt(0))
                ...
                var g = [M.g.R]
                  , h = Bq(f, M.g.Sb, R(f.m, M.g.Sb));
                (h || Ds(f)) && g.push(M.g.J);
                (Q(48) && h || Q(12) && Ds(f)) && g.push(M.g.N);
                Bt(function() {
                    Jl(function() {
                        d.Ym(f)
                    }, g)
    ...
    aa.Ym = function(a) {
        ...
        try {
            ...
            if (0 <= At.Kl.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = Fs(a);
            ...
            "http:" != g && "https:" != g && (L(29),
            a.isAborted = !0);
            Jc && "preview" == Jc.loadPurpose && (L(30),
            a.isAborted = !0);
            Q(85) && (a.isAborted = !0);
            er(a);
            var h = {}
            ...
            0 === n && gG(26);
            var p = {
                prefix: String(R(a.m, M.g.Oa, "")),
                path: String(R(a.m, M.g.Rb, "/")),
                flags: String(R(a.m, M.g.Za, "")),
                domain: String(R(a.m, M.g.Ua, "auto")),
                yb: Number(R(a.m, M.g.Va, 63072E3))
            };
            ...
            if (a.metadata.euid_mode_enabled && Bq(a, "ccd_add_1p_data", !1)) {
                ...
                if (ij(q)) {
                    ...
                    Ta(q.selectors) && !a.metadata.user_data_from_manual && (a.metadata.user_data_from_manual = hj(q.selectors)))
                }
            }
            if (Q(54) && Bq(a, "ga4_ads_linked", !1) && a.eventName === M.g.ba) {
                var t = !1 !== R(a.m, M.g.ra);
                if (t) {
                    var u = Yq(a);
            ...
            var v = this.dk, w;
            R(a.m, M.g.Wa) && (T(M.g.R) || R(a.m, M.g.nb) || (a.h[M.g.oj] = !0));
            var x;
            var y;
            y = void 0 === y ? 3 : y;
            var B = l.location.href;
            ...
            v.call(this, w);
            var H = a.eventName === M.g.ba;
            H && (this.T = !0);
            a.eventName == M.g.ba && (R(a.m, M.g.Ka, !0) ? (a.m.h[M.g.ia] && (a.m.C[M.g.ia] = a.m.h[M.g.ia],
            a.m.h[M.g.ia] = void 0,
            a.h[M.g.ia] = void 0),
            a.eventName = M.g.Ob) : a.isAborted = !0);
            H && !a.isAborted && 0 < this.nd++ && gG(17);
            ...
            var La = tb(R(a.m, M.g.kd, 30));
            La = Math.min(475, La);
            La = Math.max(5, La);
            var mb = tb(R(a.m, M.g.rf, 1E4))
              , Na = qG(ya);
            ...
            if (ud)
                ...
                Z.hm(a);
            else if (Z.Wl() > mb || a.eventName == M.g.Ob)
                Na.Ad = !0;
            a.metadata.euid_mode_enabled ? R(a.m, M.g.Qa) ? Na.Gc = !0 : (Na.Gc && !Q(10) && (Na.we = void 0),
            Na.Gc = !1) : Na.Gc = !1;
            var mh = Na.we
              , GJ = Q(95) && Ds(a);
            ...
            S ? (a.copyToHitData(M.g.ub, Na.sessionId),
            a.copyToHitData(M.g.de, Na.Lc),
            a.copyToHitData(M.g.ce, Na.Ad ? 1 : 0)) : (a.h[M.g.ub] = Na.sessionId,
            a.h[M.g.de] = Na.Lc,
            a.h[M.g.ce] = Na.Ad ? 1 : 0);
            a.metadata[M.g.jf] = Na.Gc ? 1 : 0;
            yH(a);
            if (!R(a.m, M.g.Tb) || !R(a.m, M.g.Gb)) {
                var Zw = ""
                  , nh = z.location;
                if (nh) {
                    var Ij = nh.pathname || "";
                    "/" != Ij.charAt(0) && (Ij = "/" + Ij);
                    Zw = nh.protocol + "//" + nh.hostname + Ij + nh.search
                }
                ...
                a: {
                    ...
                    if (void 0 !== Bi.ga4_referrer_override)
                        ...
                        var bx = aj("gtm.gtagReferrer." + a.target.fa)
                          , LJ = z.referrer;
                        Jj = bx ? "" + bx : LJ
                    }
                }
                ...
                a.copyToHitData(M.g.Pa, (Jc.language || "").toLowerCase());
                var cx = Hr();
                a.copyToHitData(M.g.Ib, cx.width + "x" + cx.height);
                Q(91) && a.copyToHitData(M.g.gd, void 0, rH);
                Q(60) && Gq() && a.copyToHitData(M.g.ed, "1")
            }
            a.metadata.create_dc_join = !1;
            a.metadata.create_google_join = !1;
            if (!(Ui.s || Q(8) && Ds(a) || a.metadata.is_merchant_center || !1 === R(a.m, M.g.lb)) && HE() && T(M.g.J)) {
                var dx = Cs(a);
                (a.metadata.is_session_start || R(a.m, M.g.lf)) && (a.metadata.create_dc_join = !!dx);
                var ex;
            ...
            zH(a);
            pi.hasOwnProperty(a.eventName) && (a.metadata.is_ecommerce = !0,
            a.copyToHitData(M.g.aa),
            a.copyToHitData(M.g.Aa));
            a.copyToHitData(M.g.uf);
            for (var fx = R(a.m, M.g.nf) || [], Nn = 0; Nn < fx.length; Nn++) {
                var gx = fx[Nn];
                if (gx.rule_result) {
            ...
            if (!a.metadata.is_merchant_center && Qj(a.m)) {
                var hx = yG(a) || {}
                  , NJ = (Wo(hx[M.g.Ub], !!hx[M.g.W]) ? Mo(!0)._fplc : void 0) || (0 < co("FPLC", void 0, void 0, M.g.R).length ? void 0 : "0");
                a.h._fplc = NJ
            }
            if (void 0 !== R(a.m, M.g.dd))
                a.copyToHitData(M.g.dd);
            else {
                var ix = R(a.m, M.g.pf), On, Kj;
                a: {
                    if (BG) {
                        var Pn = yG(a) || {};
                        if (Pn && Pn[M.g.W])
                            for (var jx = Aj(Ej(a.h[M.g.Ea]), "host", !0), Lj = Pn[M.g.W], oh = 0; oh < Lj.length; oh++)
                                if (Lj[oh]instanceof RegExp) {
                                    if (Lj[oh].test(jx)) {
                                        Kj = !0;
                                        break a
                                    }
                                } else if (0 <= jx.indexOf(Lj[oh])) {
                                    Kj = !0;
                                    break a
                                }
                    }
                ...
                if (!(On = Kj)) {
                    ...
                    if (Mj = ix)
                        a: {
                            for (var kx = ix.include_conditions || [], OJ = Aj(Ej(a.h[M.g.Ea]), "host", !0), Qn = 0; Qn < kx.length; Qn++)
                                if (kx[Qn].test(OJ)) {
                                    Mj = !0;
                                    break a
                                }
            ...
            tl() && Gs(a, "rnd", Cq()));
            if (Q(63) && Ds(a)) {
                Bq(a, M.g.Sb, !1) && Gs(a, "gse", 1);
                !1 === R(a.m, M.g.lb, void 0, 4) && Gs(a, "ngs", 1);
                qj() && Gs(a, "ga_rd", 1);
                HE() || Gs(a, "ngst", 1);
                var lx = uj();
                lx && Gs(a, "etld", lx)
            ...
            Q(71) && Q(80) && Gs(a, "sw_exp", 1);
            Q(82) && Ds(a) && (a.metadata.speculative && Gs(a, "sp", 1),
            a.metadata.is_syn && Gs(a, "syn", 1),
            a.metadata.em_event && (Gs(a, "em_event", 1),
            Gs(a, "sp", 1)));
            Q(97) && Ds(a) && !1 !== R(a.m, M.g.Da) && Et("join-ad-interest-group") && kb(Jc.joinAdInterestGroup) && Gs(a, "flg", 1);
            if (!vt(l))
                L(87);
            else if (void 0 !== xt) {
                L(85);
                var rx = tt();
                rx ? R(a.m, M.g.be) && !Ds(a) || Ct(rx, a) : L(86)
            }
            var Rn = Et(Dt());
            Rn || AH || (AH = !0,
            ...
            Rn = Et(Dt()));
            Rn && (a.h[M.g.Qb] = "1");
            if (!1 !== R(a.m, M.g.Da) && Bn(a.m)) {
                var PJ = Cs(a)
                  , QJ = R(a.m, M.g.lb);
                PJ && !1 !== QJ && HE() && T(M.g.J) && (!Q(48) || pl(M.g.N) && rl(["ads"]).ads) && Et("join-ad-interest-group") && kb(Jc.joinAdInterestGroup) && (a.h[M.g.Pg] = !0)
            }
            Q(33) && fr(a);
            ...
            Cr(a);
            kH(a);
            Q(82) && Ds(a) && (a.metadata.speculative = !1);
            var vx = R(a.m, M.g.Gb);
            vx && gG(12);
            a.metadata.em_event && gG(14);
            var ph = hk(ik());
            (vx || uk(ph) || ph && ph.parent && ph.context && 5 === ph.context.source) && gG(19);
            !this.T && a.metadata.em_event && gG(18);
            var Sn = a.metadata.event_usage;
            if (Array.isArray(Sn))
                for (var Tn = 0; Tn < Sn.length; Tn++)
                    gG(Sn[Tn]);
            var wx = hb("GA4_EVENT");
            wx && (a.h._eu = wx);
            ...
            var SJ = this.dk, xx, TJ = this.h, Un;
            a: {
                var Vn = xG(a);
                if (Vn) {
                    if (vG(Vn, a)) {
            ...
            this.Zb = !0;
            this.tn(a);
            if (Q(79) && T(M.g.R) && (Ds(a) && Q(80) && (Q(71) || Q(70)) && (a.metadata.is_sgtm_service_worker = !0),
            Q(71)))
                a: {
                    if (Q(80) && Ds(a)) {
                        var VJ = Nj(Qj(a.m), "/_");
            ...
            if (Ds(a)) {
                ...
                if ("page_view" === a.eventName || WJ)
                    sH(this, a, M.g.J),
                    Q(12) && sH(this, a, M.g.N)
            }
            this.F.Zh();
            a.copyToHitData(M.g.Fg);
            R(a.m, M.g.be) && (a.h[M.g.be] = !0,
            Ds(a) || qH(a));
            if (a.isAborted) {
                a.m.onFailure();
                hG();
    ...
    ;
    aa.Uk = function(a) {
        a.eventName !== M.g.Sa && this.F.Tk(a)
    }
    ;
    var xH = function(a) {
        function b(c, d) {
    ...
    ;var BH = function(a) {
        if (Q(4) && "prerendering"in z ? z.prerendering : "prerender" === z.visibilityState)
            return !1;
        a();
        return !0
    }
      , CH = function(a) {
        if (!BH(a)) {
            var b = !1
              , c = function() {
                !b && BH(a) && (b = !0,
                Wc(z, "visibilitychange", c),
                Q(4) && Wc(z, "prerenderingchange", c),
                L(55))
            };
            Vc(z, "visibilitychange", c);
            Q(4) && Vc(z, "prerenderingchange", c);
            L(54)
        }
    };
    var EH = function(a, b) {
    ...
    function FH(a, b, c) {
        ...
        d.dn(function() {
            cG = !0;
            wm.flush();
            1E3 <= d.Rf() && Jc.sendBeacon && ym(M.g.Nc, {}, a.id, f);
            b.flush();
            d.ek(function() {
                cG = !1;
                d.ek()
    ...
    ;var TI = function() {
        ...
        QI("assertThat", $g);
        QI("decodeUri", dh);
        QI("decodeUriComponent", eh);
        QI("encodeUri", fh);
        QI("encodeUriComponent", gh);
        QI("fail", qh);
        QI("generateRandom", rh);
        QI("getTimestamp", sh);
        QI("getTimestampMillis", sh);
        QI("getType", th);
        QI("makeInteger", vh);
        QI("makeNumber", wh);
        QI("makeString", xh);
    ...
    (function(a) {
        ...
        if (Li)
            ...
            var f = function(u) {
                ...
                Rc("https://" + Ai.Fd + "/debug/bootstrap?id=" + bg.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + Yn()));
                var y = {
            ...
            if (!h && z.referrer) {
                var p = Ej(z.referrer);
                "tagassistant.google.com" === zj(p, "host") && (h = g.il)
            }
            if (!h) {
        ...
        try {
            ...
            if (Uj().canonical[a]) {
                ...
                yK();
                if (!Li)
                    for (var Z = rj() ? Wi(Ui.M) : Wi(Ui.T), S = 0; S < Al.length; S++) {
                        var U = Al[S]
                          , da = U
                          , fa = Z[U] ? "granted" : "denied";
                        il().implicit(da, fa)
                    }
                hz();
                cw = !1;
                ...
                if ("interactive" == z.readyState && !z.createEventObject || "complete" == z.readyState)
                    ...
                    Vc(z, "DOMContentLoaded", fw);
                    Vc(z, "readystatechange", fw);
                ...
                wy = !1;
                "complete" === z.readyState ? yy() : Vc(l, "load", yy);
                Ck && (xk(Qk),
