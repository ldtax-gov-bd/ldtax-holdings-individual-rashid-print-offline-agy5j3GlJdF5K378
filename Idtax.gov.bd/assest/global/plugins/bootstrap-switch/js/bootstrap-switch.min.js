    ...
    !function(e, s) {
        ...
        return o = function() {
            ...
            t.prototype.state = function(t, e) {
                return "undefined" == typeof t ? this.options.state : this.options.disabled || this.options.readonly || this.options.indeterminate ? this.$element : this.options.state && !this.options.radioAllOff && this.$element.is(":radio") ? this.$element : (t = !!t,
            ...
            t.prototype.animate = function(t) {
                ...
                this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-animate"),
            ...
            t.prototype.disabled = function(t) {
                ...
                this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-disabled"),
            ...
            t.prototype.readonly = function(t) {
                ...
                this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-readonly"),
            ...
            t.prototype.indeterminate = function(t) {
                ...
                this.$wrapper[t ? "addClass" : "removeClass"]("" + this.options.baseClass + "-indeterminate"),
            ...
            t.prototype.radioAllOff = function(t) {
                return "undefined" == typeof t ? this.options.radioAllOff : (this.options.radioAllOff = t,
                this.$element)
            }
            ,
                ...
                return this.$element.on({
                    "change.bootstrapSwitch": function(t) {
                        return function(s, o) {
                            ...
                            n !== t.options.state ? (t.options.state = n,
                            ...
                            o ? void 0 : (t.$element.is(":radio") && e("[name='" + t.$element.attr("name") + "']").not(t.$element).prop("checked", !1).trigger("change.bootstrapSwitch", !0),
                            t.$element.trigger("switchChange.bootstrapSwitch", [n]))) : void 0
                        }
                    }(this),
            ...
            t.prototype._labelHandlers = function() {
                return this.$label.on({
                    "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": function(t) {
                        return function(e) {
                            ...
                            if (t.isLabelDragging)
                                ...
                                n = (o - t.$wrapper.offset().left) / t.$wrapper.width() * 100,
                                s = 25,
                                i = 75,
                    ...
                    "mousedown.bootstrapSwitch touchstart.bootstrapSwitch": function(t) {
                        return function(e) {
                            return t.isLabelDragging || t.options.disabled || t.options.readonly || t.options.indeterminate ? void 0 : (e.preventDefault(),
                            t.isLabelDragging = !0,
                            t.$element.trigger("focus.bootstrapSwitch"))
                        }
                    }(this),
                    "mouseup.bootstrapSwitch touchend.bootstrapSwitch": function(t) {
                        return function(e) {
                            return t.isLabelDragging ? (e.preventDefault(),
                            t.isLabelDragged ? (t.isLabelDragged = !1,
                            t.state(parseInt(t.$container.css("margin-left"), 10) > -(t.$container.width() / 6)),
                            t.options.animate && t.$wrapper.addClass("" + t.options.baseClass + "-animate"),
                            t.$container.css("margin-left", "")) : t.state(!t.options.state),
                            t.isLabelDragging = !1) : void 0
                        }
                    }(this),
            ...
            t.prototype._getClasses = function(t) {
                ...
                i = t.length; i > n; n++)
                    s = t[n],
                    o.push("" + this.options.baseClass + "-" + s);
                return o
            }
            ,
            t
